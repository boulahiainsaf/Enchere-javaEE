...
public class ServletInscription extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/view/inscription.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		mdpConfirme = request.getParameter("mdp2");
		...
		if(listeErreurs.size()>0) {
			...
			try {
				...
				Utilisateur utilisateur = utilisateurManager.createUtilisateur(pseudo, nom, prenom, email, telephone, rue, cp, ville, mdp, mdpConfirme);
